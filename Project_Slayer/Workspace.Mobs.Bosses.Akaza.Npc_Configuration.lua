...
-- Decompiled on 2025-04-29 16:42:03
-- Luau version 6, Types version 3
-- Time taken: 0.012839 seconds
...
local module_upvr = {
	...
	Npc_Spawning = {
		...
		Spawn_Locations = {Vector3.new(2020.34, 553.500, -124.49)};
	};
	Following = {
		Following_Id = "";
		Player = nil;
	...
	On_Idle = {
		...
		Move_To_Locations = {Vector3.new(-175.47, 1.5, -159.25), Vector3.new(-105.48, 0.5, -111.21), Vector3.new(-107.66, 0.5, -221.89)};
	};
	Defaults = {
		WalkSpeed = 16;
		JumpPower = 50;
