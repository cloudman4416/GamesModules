...
-- Decompiled on 2025-04-29 15:03:56
-- Luau version 6, Types version 3
-- Time taken: 0.013940 seconds
...
local module_upvr = {
	...
	Night_Settings = {
		Last_damaged = 0;
		Damaged_every = 0.65;
		Spawn_Only_During_Night = true;
		Damage_During_Day = true;
	};
	Npc_Spawning = {
		Spawn_Time = 120;
		...
		Spawn_Locations = {Vector3.new(4357.24, 339.714, -4380.9)};
	};
	Clashing = {
		Last = 0;
		CoolDown = 0.03;
	...
	On_Idle = {
		...
		Move_To_Locations = {Vector3.new(-34.395, 0.5, 45.3219), Vector3.new(50.2260, 0.44999, 83.1699), Vector3.new(0.58300, -0.5, 130.572)};
	};
	Defaults = {
		WalkSpeed = 19;
		JumpPower = 50;
