...
-- Decompiled on 2025-04-29 16:40:18
-- Luau version 6, Types version 3
-- Time taken: 0.012526 seconds
...
local module_upvr = {
	...
	Name = "Sound Trainee";
	Code = "Sound_Trainee";
	Quest_Return = "Sound_Trainee_Killed";
	Heal = {
		Heal_Every = 1;
	...
	Npc_Spawning = {
		...
		Spawn_Locations = {Vector3.new(1887.34, 660.916, -2795.2)};
	};
	Following = {
		Following_Id = "";
		Player = nil;
	...
	On_Idle = {
		...
		Move_To_Locations = {Vector3.new(1821.95, 660.127, -2807.2), Vector3.new(1911.61, 660.916, -2773.5), Vector3.new(1926.57, 660.127, -2845.0)};
	};
	Defaults = {
		WalkSpeed = 16;
		JumpPower = 50;
